        ...
        ;; Usage: ./ff -o shakey-domain.pddl -f shakey-task-2-12rooms-4objs.pddl
        ;; Usage: ./ipp -o shakey-domain.pddl -f shakey-task-2-12rooms-4objs.pddl



        (define (problem shakey-task-2-12rooms-4objs)
          (:domain shakey)
          (:objects
            ;; static:

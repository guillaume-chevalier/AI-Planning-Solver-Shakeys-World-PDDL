        ...
        ;; Usage: ./ff -o shakey-domain.pddl -f shakey-task-2-6rooms-8objs.pddl
        ;; Usage: ./ipp -o shakey-domain.pddl -f shakey-task-2-6rooms-8objs.pddl



        (define (problem shakey-task-2-6rooms-8objs)
          (:domain shakey)
          (:objects
            ;; static:
